...
Put in 'shiny app' and then tap will give the following code.  
```{r, eval=F, echo=T}
library(shiny)
...
) #"x"=the name of the variable, selected()=start with (this colomn)
...
ui <- fluidPage(
    ...
    selectInput("y", "Select Y Variable", choices = c("bill_length_mm", "bill_depth_mm", "flipper_length_mm", "body_mass_g"), selected = "bill_length_mm") #no ',' at the end of this line
