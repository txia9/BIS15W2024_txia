...
homerange2 is not R markdown, copy paste all the code without the code chunk.  
## Aesthetics
...
```{r}
library(shiny) ######something wrong with this code, copy paste Ledford's code

ui <- fluidPage(titlePanel("Log 10 Homerange by Taxon"), #add the title
