...
R is a programming language that is usually used in statistic related field. RStudio is a program for programmers to write R. RStudio would be useless if not using R language. GitHub is a online interconnecting platform that allow programmers to share their code. It is useful because it allows programmers to review and edit the code at the same time. 
