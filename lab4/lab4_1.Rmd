...
The - operator is useful in select. It allows us to select everything except the specified variables. remove the un-needed colomns
```{r}
...
```{r}
mammals_new <- rename(mammals, genus="Genus", afr="AFR", max_life="max. life", wean_mass ="wean mass", litter_size="litter size", litters_year="litters/year")
mammals_new
```
...
#or select_if(mammals_new, ~is.character(.))
```
